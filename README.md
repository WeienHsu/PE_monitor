...
系統根據 EPS 波動率自動將股票分類，影響哪些補充指標會被納入綜合訊號：

| 類型 | 觸發條件 | 關鍵指標 | 備註 |
|------|---------|---------|------|
| **穩定型** ★★★★★ | EPS 波動 < 30% | P/CF（權重最高）、PEG、Forward P/E | 現金流品質最重要 |
| **成長型** ★★★ | EPS 波動 30–60% | PEG（權重最高）、Forward P/E | P/CF 停用（成長股大量再投資） |
| **景氣循環型** ★★ | EPS 波動 > 60% 或曾為負值 | P/CF、EV/EBITDA | PEG/Forward P/E 不可信，訊號調整幅度保守 |
